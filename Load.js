...
class Load extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('intro_01', 'assets/audio/intro_01.mp3');
    this.load.audio('g5_17_we no longer have this', 'assets/audio/g5_17_we no longer have this.mp3');
    this.load.audio('g6_02_done making', 'assets/audio/g6_02_done making.mp3');
    this.load.audio('general_07_well done', 'assets/audio/general_07_well done.mp3');
    this.load.audio('general_08_haay', 'assets/audio/general_08_haay.mp3');
    this.load.audio('general_09_woow', 'assets/audio/general_09_woow.mp3');
    this.load.audio('general_10_nice', 'assets/audio/general_10_nice.mp3');
    ...
    this.load.audio('wrongchoicex', 'assets/audio/wrongchoicex.mp3');
    ...
    this.load.on('complete', function () {
      myScene.start("Menu", {fromLoad: 1, levelNum: 1, levelDiff: 1});
    });
