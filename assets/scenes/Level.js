...
class Level extends Phaser.Scene {
	...
	_create() {
		...
		// movingPlatform2 (prefab fields)
		movingPlatform2.emit("prefab-awake");
		...
		// movingPlatform1 (prefab fields)
		movingPlatform1.emit("prefab-awake");
		...
		// movingPlatform3 (prefab fields)
		movingPlatform3.emit("prefab-awake");
		...
		// container_2_1 (prefab fields)
		container_2_1.emit("prefab-awake");
		...
		// ladder5 (prefab fields)
		ladder5.emit("prefab-awake");
		
		// ladder5 (components)
		ladder5.emit("components-awake");
		
		// ladder4 (prefab fields)
		ladder4.emit("prefab-awake");
		
		// ladder4 (components)
		ladder4.emit("components-awake");
		
		// ladder3 (prefab fields)
		ladder3.emit("prefab-awake");
		
		// ladder3 (components)
		ladder3.emit("components-awake");
		
		// ladder2 (prefab fields)
		ladder2.emit("prefab-awake");
		
		// ladder2 (components)
		ladder2.emit("components-awake");
		
		// ladder1 (prefab fields)
		ladder1.emit("prefab-awake");
		
		// ladder1 (components)
		ladder1.emit("components-awake");
		
		// ladder6 (prefab fields)
		ladder6.emit("prefab-awake");
		...
		// meet3 (prefab fields)
		meet3.emit("prefab-awake");
		
		// meet2 (prefab fields)
		meet2.emit("prefab-awake");
		
		// banana (prefab fields)
		banana.emit("prefab-awake");
		
		// apple (prefab fields)
		apple.emit("prefab-awake");
		
		// cherry (prefab fields)
		cherry.emit("prefab-awake");
		
		// apple2 (prefab fields)
		apple2.emit("prefab-awake");
		
		// banana1 (prefab fields)
		banana1.emit("prefab-awake");
		
		// meet1 (prefab fields)
		meet1.emit("prefab-awake");
		
		// btn_left (prefab fields)
		btn_left.emit("prefab-awake");
		...
		// btn_right (prefab fields)
		btn_right.emit("prefab-awake");
		...
		// btn_up (prefab fields)
		btn_up.emit("prefab-awake");
