...
class GameOver extends Phaser.Scene {
	...
	constructor() {
		...
		this.fromLevel;		//check which level it was coming from
		this.levelDiff;		//store current difficulty
		this.score;			//score earned
		this.rightCount;		//Total number of right number
		this.wrongCount;		//Total number of wrong number
		this.stars;			//number of stars
		/* END-USER-CTR-CODE */
	}
